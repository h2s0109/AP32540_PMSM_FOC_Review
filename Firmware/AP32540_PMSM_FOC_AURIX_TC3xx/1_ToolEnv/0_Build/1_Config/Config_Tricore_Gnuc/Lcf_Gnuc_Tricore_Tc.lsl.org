...
MEMORY
{
    ...
    lmuram (w!xp): org = 0x90040000, len = 1M
    lmuram_nc (w!xp): org = 0xb0040000, len = 1M
    
    cpu4_dlmu (w!xp): org = 0x90140000, len = 64K
    cpu4_dlmu_nc (w!xp): org = 0xb0140000, len = 64K
    
    cpu5_dlmu (w!xp): org = 0x90150000, len = 64K
    cpu5_dlmu_nc (w!xp): org = 0xb0150000, len = 64K
...
/*Sections located at absolute fixed address*/
    ...
    SECTIONS
    {
        ...
        { PROVIDE(__HEAP = .);    . = . + LCF_HEAP_SIZE;    PROVIDE(__HEAP_END = .); }
