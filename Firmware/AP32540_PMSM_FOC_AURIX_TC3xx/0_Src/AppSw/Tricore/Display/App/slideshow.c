/**
 * \file slideshow.c
 * \brief Source file for our slide show on the display
 *
...
uint32 start_slideshow (void)
{
    ...
    /* we disable our blinking led */
   	IfxPort_setPinModeInput(LIFEHOLD_LED.port, LIFEHOLD_LED.pinIndex, IfxPort_InputMode_pullUp); //Set Pin13_3 as Input with pull-up to switch off
