/*
 * \file Evadc_InitCurSenseLsTwoShunt.h
 * \brief
 * \ingroup
 * \version 
...
#ifndef EVADC_INITCURSENSELSTWOSHUNT_H_
#define EVADC_INITCURSENSELSTWOSHUNT_H_
 ...
 * /ingroup
 */
IFX_INLINE void PmsmFoc_Evadc_initGroupXQueue0CurrentSenseTwoShunt(IfxEvadc_Adc_GroupConfig *adcGroupConfig)
{
    ...
    adcGroupConfig->queueRequest[0].triggerConfig.triggerSource=
        ADCTRIG_U_SOURCE;               /* GTM ADC trigger 1 */
}
 ...
 * /ingroup
 */
IFX_INLINE void PmsmFoc_Evadc_initGroupXQueue0CurrentSenseTwoShunt2(IfxEvadc_Adc_GroupConfig *adcGroupConfig)
{
    /* Queue0 is enabled, enable the request slot for the arbiter */
    adcGroupConfig->arbiter.requestSlotQueue0Enabled= TRUE;
    ...
    adcGroupConfig->queueRequest[0].triggerConfig.triggerMode=
        IfxEvadc_TriggerMode_uponRisingEdge;
    adcGroupConfig->queueRequest[0].triggerConfig.triggerSource=
        ADCTRIG_V_SOURCE;               /* GTM ADC trigger 2 */
}
 ...
 * with below topology
 * Three phase current sense with (per phase) low-side shunt resistors.
 * G0.Queue0    Priority-Highest    Triggered by TOM0-CH15 (GTM ADC trigger 1)
 *
* /param adcGroupConfig Reference to structure that contains instance data members
 * /return
 * /note
...
{
	PmsmFoc_Evadc_initGroupXQueue0CurrentSenseTwoShunt(adcGroupConfig);
}
 ...
 * with below topology
 * Three phase current sense with (per phase) low-side shunt resistors.
 * G3.Queue0    Priority-Highest    Triggered by TOM0-CH15 (GTM ADC trigger 1)
 *
...
{
	PmsmFoc_Evadc_initGroupXQueue0CurrentSenseTwoShunt2(adcGroupConfig);
}
#endif /* End of (PHASE_CURRENT_RECONSTRUCTION == USER_LOWSIDE_TWO_SHUNT_MONITORING) */
