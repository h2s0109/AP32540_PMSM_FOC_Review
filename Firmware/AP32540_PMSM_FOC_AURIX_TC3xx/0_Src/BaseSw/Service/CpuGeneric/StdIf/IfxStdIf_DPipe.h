...
#if !defined(IFX_CFG_STDIF_DPIPE_TIMEOUT)
#define IFX_CFG_STDIF_DPIPE_TIMEOUT (TIME_INFINITE) /**<\brief Default DPipe Tx timeout */
#endif
...
struct IfxStdIf_DPipe_
{
    ...
    Ifx_TickTime             writeTimeout;        /**< \brief Write timeout */
...
/** \brief Disable Tx
 */
IFX_INLINE void IfxStdIf_DPipe_disableTx(IfxStdIf_DPipe *stdIf)
{
    stdIf->txDisabled = TRUE;
}

/** \brief Enable Tx
 */
IFX_INLINE void IfxStdIf_DPipe_enableTx(IfxStdIf_DPipe *stdIf)
{
    stdIf->txDisabled = FALSE;
}

/** \return Return TRUE if Tx is disabled
 */
IFX_INLINE boolean IfxStdIf_DPipe_isTxDisabled(IfxStdIf_DPipe *stdIf)
{
    return stdIf->txDisabled;
}

/**
 * @return Return the write timeout
 */
IFX_INLINE Ifx_TickTime IfxStdIf_DPipe_getWriteTimeout(IfxStdIf_DPipe *stdIf)
{
    return stdIf->writeTimeout;
}
/**
 * @return Set the write timeout
 */
IFX_INLINE void IfxStdIf_DPipe_setWriteTimeout(IfxStdIf_DPipe *stdIf, Ifx_TickTime timeout)
{
    stdIf->writeTimeout = timeout;
}


IFX_EXTERN void IfxStdIf_DPipe_print(IfxStdIf_DPipe *stdIf, pchar format, ...);
IFX_EXTERN void IfxStdIf_DPipe_printVA(IfxStdIf_DPipe *stdIf, pchar format, va_list args);
IFX_EXTERN void IfxStdIf_DPipe_writeText(IfxStdIf_DPipe *stdIf, pchar text);

IFX_EXTERN void IfxStdIf_DPipe_initStdIf(IfxStdIf_DPipe *stdIf);
